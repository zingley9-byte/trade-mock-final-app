...
export default function AuthScreen() {
  ...
  async function handleSubmit() {
    ...
    await AsyncStorage.setItem(TM_AUTH_KEY, JSON.stringify({ email, name: name || email.split("@")[0] }));
    setLoading(false);
    router.replace("/(tabs)");
  }
  ...
  async function handleGoogle() {
    ...
    await AsyncStorage.setItem(TM_AUTH_KEY, JSON.stringify({ email: "google@user.com", name: "Trader" }));
    setLoading(false);
    router.replace("/(tabs)");
  }
