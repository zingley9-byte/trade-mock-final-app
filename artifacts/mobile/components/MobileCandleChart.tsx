...
const MOBILE_TOOL_GROUPS: Array<MToolGroup | "sep"> = [
  ...
  "sep",
  { id:"magnet",   icon:"magnet-outline",      label:"Magnet Mode",  toggle:true,
    items:[{id:"magnet",label:"Strong magnet",icon:"magnet-outline"},{id:"magnet",label:"Weak magnet",icon:"magnet-outline"},{id:null,label:"Magnet off",icon:"close-circle-outline"}]},
