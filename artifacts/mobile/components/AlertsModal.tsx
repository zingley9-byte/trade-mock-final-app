    ...
    return (
      <View style={[styles.alertRow, { borderBottomColor: colors.border }]}>
        ...
        <TouchableOpacity onPress={() => removeAlert(item.id)} style={styles.deleteBtn}>
          <SvgIcon name="trash-outline" size={16} color={colors.mutedForeground} />
        </TouchableOpacity>
      </View>
    );
  }
    ...
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
      ...
      <View style={[styles.sheet, { backgroundColor: colors.card }]}>
        ...
        {notifPermission !== "granted" && (
          ...
          >
            <SvgIcon name="notifications-off-outline" size={14} color="#f59e0b" />
        ...
        <View style={[styles.form, { backgroundColor: colors.muted, borderColor: colors.border }]}>
          ...
          <TouchableOpacity
            ...
            onPress={handleAdd}
          >
            <SvgIcon name="notifications-outline" size={14} color="#fff" />
        ...
        {alerts.length === 0 ? (
          <View style={styles.emptyWrap}>
            <SvgIcon name="notifications-outline" size={32} color={colors.mutedForeground} />
